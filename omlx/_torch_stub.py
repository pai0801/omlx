...
xgrammar 0.2.3–0.2.5 declares ``torch>=1.10.0`` as a runtime dep, but oMLX never
...
_TARGET_XGRAMMAR_VERSIONS = ("0.2.3", "0.2.4", "0.2.5")
# NOTE: xgrammar 0.2.5 ships cp310-only wheels (no cp311+), so dev/bundle
# installs pin 0.2.4; the stub covers 0.2.5 for any manual install.
_TARGET_TVM_FFI_VERSIONS = ("0.1.11", "0.1.12", "0.1.13", "0.1.13.post1", "0.1.13.post2", "0.1.13.post3")
